...
public class Instructions extends BorderPane {
	...
	private static BorderPane getPage1() {
		...
		try {
			img_evolution = new ImageView(new Image(new FileInputStream("src/evolution.png")));
	...
	private static BorderPane getPage5() {
		...
		try {
			evoSim_UI = new ImageView(new Image(new FileInputStream("src/user_interface.png")));
	...
	private static BorderPane getPage6() {
		...
		ImageView evoSim_UI = new ImageView();
		try {
			evoSim_UI = new ImageView(new Image(new FileInputStream("src/user_interface2.png")));
	...
	private static BorderPane getPage12() {
		...
		ImageView img_evolution = new ImageView();
		try {
			img_evolution = new ImageView(new Image(new FileInputStream("src/evolution2.png")));
